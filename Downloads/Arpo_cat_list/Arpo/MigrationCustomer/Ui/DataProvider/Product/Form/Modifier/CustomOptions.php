 ...
 */
namespace Arpo\MigrationCustomer\Ui\DataProvider\Product\Form\Modifier;
...
//     * @return array
//     */
//    protected function getProductSkuFieldConfig($sortOrder, array $options = [])
//    {
//        return array_replace_recursive(
//            [
//                'arguments' => [
//                    'data' => [
//                        'config' => [
//                            'label' => __('Zugehöriges Produkt'),
//                            'componentType' => Field::NAME,
//                            'formElement' => Input::NAME,
//                            'dataScope' => static::FIELD_PRODUCT_SKU,
//                            'dataType' => Text::NAME,
//                            'sortOrder' => $sortOrder,
//                        ],
//                    ],
