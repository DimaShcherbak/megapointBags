...
namespace SDN\StreetAddress\Plugin\Checkout\Block\Checkout\AttributeMerger;
...
//        }
        ...
        if (array_key_exists('street', $result)) {
            // Добавляем значение по умолчанию для первой строки поля "street"
            $result['street']['children'][0]['value'] = '-';
        }
