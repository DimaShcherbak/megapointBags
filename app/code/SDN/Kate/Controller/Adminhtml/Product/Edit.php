...
class Edit extends \SDN\Kate\Controller\Adminhtml\Product
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\SDN\Kate\Model\Product::class);
        ...
        $this->_coreRegistry->register('sdn_kate_product', $model);
