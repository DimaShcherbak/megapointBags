...
namespace SDN\HideBrand\Mmegamenu\Helper;
...
//        $search = '<li class="  static-menu level0">
//								<a href="http://magento246.loc/shop-by-brand" class="level0"><span>Brands</span></a>							</li>';
//        $html = str_replace($search, '', $html);
    ...
    public function filter($str)
    {
        ...
        $search = '<li class="  static-menu level0">
								<a href="' . $baseUrl . 'shop-by-brand" class="level0"><span>Brands</span></a>							</li>';
        $html = str_replace($search, '', $html);
        return $html;
