...
class Slack extends OAuth2
{
     ...
     *
     * @param \lib\internal\Mageplaza\Hybrid\Data\Collection $data response object as returned by
     *     <code>api/users.identity</code>
     *
     * @return string|null the value of the <code>image_*</code> property with
     *     the highest resolution.
     */
    private function findLargestImage(\lib\internal\Mageplaza\Hybrid\Data\Collection $data)
    {
        $maxSize = 0;
