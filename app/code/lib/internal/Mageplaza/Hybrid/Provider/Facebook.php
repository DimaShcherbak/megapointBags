...
class Facebook extends OAuth2
{
     ...
     * @throws \lib\internal\Mageplaza\Hybrid\Exception\InvalidAccessTokenException
     */
     ...
     */
    protected function fetchUserRegion(\lib\internal\Mageplaza\Hybrid\User\Profile $userProfile)
    {
     ...
     * @param array $item
     *
     * @return \lib\internal\Mageplaza\Hybrid\User\Contact
     */
    protected function fetchUserContact($item)
    {
        $userContact = new \lib\internal\Mageplaza\Hybrid\User\Contact();

        $item = new \lib\internal\Mageplaza\Hybrid\Data\Collection($item);
     ...
     * @param $item
     *
     * @return \lib\internal\Mageplaza\Hybrid\User\Activity
     */
    protected function fetchUserActivity($item)
    {
        $userActivity = new \lib\internal\Mageplaza\Hybrid\User\Activity();
