...
class CollectionTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function test_instance_of()
    {
        ...
        $this->assertInstanceOf('\\lib\\internal\\Mageplaza\\Hybrid\\Data\\Collection', $collection);
    }
    ...
    public function test_filter()
    {
        ...
        $this->assertInstanceOf('\\lib\\internal\\Mageplaza\\Hybrid\\Data\\Collection', $collection->filter('id'));
        $this->assertInstanceOf('\\lib\\internal\\Mageplaza\\Hybrid\\Data\\Collection', $collection->filter('slugs'));
        $this->assertInstanceOf('\\lib\\internal\\Mageplaza\\Hybrid\\Data\\Collection', $collection->filter('_non_existant_'));
