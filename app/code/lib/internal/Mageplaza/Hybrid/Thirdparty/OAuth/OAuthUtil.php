...
namespace lib\internal\Mageplaza\Hybrid\Thirdparty\OAuth;

use function Hybridauth\Thirdparty\OAuth\sort;
    ...
    public static function urlencode_rfc3986($input)
    {
        if (is_array($input)) {
            return array_map(array(
                '\lib\internal\Mageplaza\Hybrid\Thirdparty\OAuth\OAuthUtil',
                'urlencode_rfc3986'
            ), $input);
