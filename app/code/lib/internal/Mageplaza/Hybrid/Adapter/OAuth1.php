...
use lib\internal\Mageplaza\Hybrid\Exception\InvalidOauthTokenException;
use lib\internal\Mageplaza\Hybrid\Thirdparty\OAuth\OAuthConsumer;
use lib\internal\Mageplaza\Hybrid\Thirdparty\OAuth\OAuthRequest;
use lib\internal\Mageplaza\Hybrid\Thirdparty\OAuth\OAuthSignatureMethodHMACSHA1;
use lib\internal\Mageplaza\Hybrid\Thirdparty\OAuth\OAuthUtil;
...
abstract class OAuth1 extends AbstractAdapter implements AdapterInterface
{
    ...
    protected function validateAuthTokenRequest($response)
    {
        ...
        $collection = new \lib\internal\Mageplaza\Hybrid\Data\Collection($tokens);
