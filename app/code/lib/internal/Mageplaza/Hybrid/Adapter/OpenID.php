...
use lib\internal\Mageplaza\Hybrid\Exception\InvalidOpenidIdentifierException;
use lib\internal\Mageplaza\Hybrid\Exception\UnexpectedApiResponseException;
use lib\internal\Mageplaza\Hybrid\Thirdparty\OpenID\LightOpenID;
...
abstract class OpenID extends AbstractAdapter implements AdapterInterface
{
    ...
    {
        $data = new \lib\internal\Mageplaza\Hybrid\Data\Collection($openidAttributes);
     ...
     * @return \lib\internal\Mageplaza\Hybrid\User\Profile
     */
    protected function fetchUserDisplayName(\lib\internal\Mageplaza\Hybrid\User\Profile $userProfile, \lib\internal\Mageplaza\Hybrid\Data\Collection $data)
    {
     ...
     * @return \lib\internal\Mageplaza\Hybrid\User\Profile
     */
    protected function fetchUserGender(\lib\internal\Mageplaza\Hybrid\User\Profile $userProfile, $gender)
    {
