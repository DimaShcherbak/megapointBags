...
use lib\internal\Mageplaza\Hybrid\Exception\HttpClientFailureException;
use lib\internal\Mageplaza\Hybrid\Exception\HttpRequestFailedException;
use lib\internal\Mageplaza\Hybrid\Exception\InvalidArgumentException;
use lib\internal\Mageplaza\Hybrid\Exception\NotImplementedException;
use lib\internal\Mageplaza\Hybrid\HttpClient\Curl as HttpClient;
use lib\internal\Mageplaza\Hybrid\HttpClient\HttpClientInterface;
use lib\internal\Mageplaza\Hybrid\Logger\Logger;
use lib\internal\Mageplaza\Hybrid\Logger\LoggerInterface;
use lib\internal\Mageplaza\Hybrid\Storage\Session;
use lib\internal\Mageplaza\Hybrid\Storage\StorageInterface;
...
abstract class AbstractAdapter implements AdapterInterface
{
    ...
    public function __construct(
        ...
        $this->config = new \lib\internal\Mageplaza\Hybrid\Data\Collection($config);
     ...
     *
     * @param array|\lib\internal\Mageplaza\Hybrid\Data\Collection $endpoints
     */
    protected function setApiEndpoints($endpoints = null)
    {
        ...
        $collection = is_array($endpoints) ? new \lib\internal\Mageplaza\Hybrid\Data\Collection($endpoints) : $endpoints;
