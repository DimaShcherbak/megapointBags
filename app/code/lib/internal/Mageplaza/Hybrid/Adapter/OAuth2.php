...
namespace lib\internal\Mageplaza\Hybrid\Adapter;

use lib\internal\Mageplaza\Hybrid\Exception\AuthorizationDeniedException;
use lib\internal\Mageplaza\Hybrid\Exception\Exception;
use lib\internal\Mageplaza\Hybrid\Exception\InvalidAccessTokenException;
use lib\internal\Mageplaza\Hybrid\Exception\InvalidApplicationCredentialsException;
use lib\internal\Mageplaza\Hybrid\Exception\InvalidAuthorizationCodeException;
use lib\internal\Mageplaza\Hybrid\Exception\InvalidAuthorizationStateException;
...
abstract class OAuth2 extends AbstractAdapter implements AdapterInterface
{
     ...
     *
     * @throws \lib\internal\Mageplaza\Hybrid\Exception\InvalidAuthorizationCodeException
     * @throws \lib\internal\Mageplaza\Hybrid\Exception\AuthorizationDeniedException
     */
    ...
    protected function authenticateBegin()
    {
        ...
        \lib\internal\Mageplaza\Hybrid\HttpClient\Util::redirect($authUrl);
    }

    /**
     * Finalize the authorization process
     *
     * @throws \lib\internal\Mageplaza\Hybrid\Exception\HttpClientFailureException
     * @throws \lib\internal\Mageplaza\Hybrid\Exception\HttpRequestFailedException
    ...
    protected function authenticateFinish()
    {
        $this->logger->debug(
            ...
            [\lib\internal\Mageplaza\Hybrid\HttpClient\Util::getCurrentUrl(true)]
        );
     ...
     *
     * @return \lib\internal\Mageplaza\Hybrid\Data\Collection
     * @throws InvalidAccessTokenException
     */
    protected function validateAccessTokenExchange($response)
    {
        $data = (new \lib\internal\Mageplaza\Hybrid\Data\Parser())->parse($response);

        $collection = new \lib\internal\Mageplaza\Hybrid\Data\Collection($data);
    ...
    public function apiRequest($url, $method = 'GET', $parameters = [], $headers = [], $multipart = false)
    {
        ...
        $response = (new \lib\internal\Mageplaza\Hybrid\Data\Parser())->parse($response);
