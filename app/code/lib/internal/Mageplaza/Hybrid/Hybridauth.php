...
namespace lib\internal\Mageplaza\Hybrid;

use lib\internal\Mageplaza\Hybrid\Exception\InvalidArgumentException;
use lib\internal\Mageplaza\Hybrid\Exception\UnexpectedValueException;
...
class Hybridauth
{
     ...
     *
     * @return \lib\internal\Mageplaza\Hybrid\Adapter\AdapterInterface
     * @throws InvalidArgumentException
